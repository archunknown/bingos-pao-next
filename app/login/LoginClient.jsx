...
export default function LoginClient({ logoUrl, nombre }) {
    ...
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-bg px-4 font-sans">
      ...
      >
        ...
        <div className="mb-8 flex flex-col items-center gap-3">
          {logoUrl ? (
            <div className="flex size-16 items-center justify-center rounded-full border-2 border-gold/60 bg-surface2 p-1 ring-4 ring-gold/20 shadow-lg shadow-gold/20">
              <img src={logoUrl} alt={nombre} className="size-full rounded-full object-cover" />
            </div>
          ) : (
